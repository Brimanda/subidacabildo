...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      MySwal.fire({
        title: 'Error',
        text: 'Hubo un error al intentar iniciar sesión. Intenta nuevamente.',
        icon: 'error',
        confirmButtonText: 'Aceptar',
      });
  ...
  return (
    <div
      className="relative h-screen bg-sky-600 bg-cover bg-center"
      style={{ backgroundImage: "url('/municipalidad.jpg')" }}
    >
      ...
      <div className="relative z-10 flex items-center justify-center h-full">
        <div className="bg-white p-10 rounded-xl shadow-lg max-w-sm w-full mx-4 md:mx-0">
          ...
          <h4 className="font-semibold text-gray-800 text-center">
            Sistema de gestión de tickets para requerimientos del área de informática
          </h4>
          <br />
